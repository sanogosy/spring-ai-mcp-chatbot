...
public class MyAiAgent {
    ...
    public Mono<String> askQuestion(String question) {
        ...
        return Mono.fromCallable(() -> {
            ...
            McpSchema.CallToolResult toolResult = client.callTool(request).block();

            if(toolResult == null || toolResult.content() == null || toolResult.content().isEmpty()) {
                return fallbackMessage();
            }

            Object firstContent = toolResult.content().stream().findFirst().orElse(null);
